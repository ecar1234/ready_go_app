                                  ...
                                  children: [
                                    SizedBox(
                                        child: Text(
                                          ...
                                          style: TextStyle(
                                              color: isDarkMode ? Colors.white : Colors.black87, fontSize: 18, fontWeight: FontWeight.w600),
                                        )),
                                    SizedBox(
                                      child: Text(
                                          "${DateUtil.dateToString(favoriteList[idx].schedule?.first ?? DateTime.now())} ~ ${DateUtil.dateToString(
                                              favoriteList[idx].schedule?.last ?? DateTime.now())}",
                                          style: TextStyle(
