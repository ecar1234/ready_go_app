...
class _AddTemplatePageState extends State<AddTemplatePage> {
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(child: Container(
                      ...
                      child: _tempList.isEmpty ?const  SizedBox(
                        child: Center(child: Text("템플릿을 추가해 보세요."),),
                      ) : Scrollbar(
                            ...
                            itemBuilder: (context, idx){
                              return SizedBox(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    SizedBox(child: Text("${idx + 1}.${_tempList[idx]}", style: TextStyle(color: Theme.of(context).colorScheme.primary, fontSize: 16, fontWeight: FontWeight.w500),)),
                                    SizedBox(
                                      height: 30,
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                    ...
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                                child: const Text("뒤로가기",style: TextStyle(color: Colors.black87),)),
                          ),
                          const Gap(20),
                          SizedBox(
                            height: 50,
                            width: 120,
                            child: ElevatedButton(
                                onPressed: _tempList.isEmpty ? null : () async {
                                  if(widget.temp == null){
                                    await _tempAddDialog(context);
                                  }else {
                                ...
                                style: ElevatedButton.styleFrom(
                                    ...
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                                child: Text(widget.temp == null ? "생성" : "수정",style: TextStyle(color: Theme.of(context).colorScheme.onPrimary),)),
                          )
                        ],
                      ),
                    )
  ...
  Future<dynamic> _tempAddDialog(BuildContext context) {
    return showDialog(
        context: context,
